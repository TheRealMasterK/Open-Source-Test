...
export default function Home() {
  ...
  return (
    <MainContainer>
      ...
      <SonnyAuthSteps currentStep={4} totalSteps={4} label="Personal Information" />
      ...
      <View style={{ marginTop: 20, gap: 12 }}>
        <SonnyButton title="Continue" onPress={() => console.log('Continue pressed')} />
        ...
        <SonnyButton title="Loading..." onPress={() => {}} loading={true} />

        <SonnyButton title="Show Success Toast (Hook)" onPress={showSuccessToast} variant="basic" />

        <SonnyButton title="Show Error Toast (Global)" onPress={showErrorToast} variant="outline" />

        <SonnyButton title="Verify OTP" onPress={handleOtpComplete} variant="custom" />
      </View>
